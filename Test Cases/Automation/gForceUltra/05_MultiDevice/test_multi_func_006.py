...
可自动化：auto（需同时有 gForceUltra + OB6000C 两台设备）
...
前置条件：
  - 主机(电脑)：蓝牙已开启
  - 待测设备：gForceUltra + OB6000C 各一台，上电、在范围内
...
def main():
    ...
    print("  - 待测设备：gForceUltra + OB6000C 各一台，上电、在范围内", flush=True)
    ...
    print("  2. gForceUltra + OB6000C 均已【开机】且在范围内", flush=True)
