# -*- coding: utf-8 -*-
"""PARAM-FUNC-004：gForceUltra EMG_SAMPLE_RATE 正反向（500/1000 设置 + 非法值 750）。
...
说明：
  gForceUltra 腕带 EMG 采样率支持 500Hz 与 1000Hz 两档，默认 1000Hz。
...
EXPECTED_RATES = ["500", "1000"]  # gForceUltra EMG 采样率两档
...
def main():
    ...
    print("=" * 60, flush=True)
    print("PARAM-FUNC-004 gForceUltra EMG_SAMPLE_RATE 正反向（500/1000 + 非法值）", flush=True)
    print("=" * 60, flush=True)
